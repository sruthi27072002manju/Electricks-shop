...
<iframe class="bot" src='https://webchat.botframework.com/embed/sruthiqna-bot?s=36CdA4mQnuU.DMExkZCT7TG2tOf_0kTr8fVMDRmL0yHEbJhi-deYX9w'  style='min-width: 400px; min-height: 500px;' hidden></iframe> </div>
    </div>
    <style>
    .bot-icon{
        position: fixed;
